...
func _ready():
	...
	GlobalEventBus.transition_camera_2d_requested.connect(on_transition_camera_2d_requested)
	GlobalEventBus.transition_camera_3d_requested.connect(on_transition_camera_3d_requested)
